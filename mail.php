...
$site_top = "http://www.j-netline.com/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "imac@stuudiomic.net";
...
お問い合わせありがとうございます。
このメールは、自動的にお送りしています。
このメールにご返信いただいても、お問い合わせにお答えすることはできませんので、ご了承願います。
＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
...
====================
有限会社Japan net-line
E-mail: info@j-netline.com
URL: http://www.j-netline.com/
====================
...
<head>
	...
	<title>お問い合わせ : 確認 - ジャパンネットライン</title>
</head>
<body>
	<header role="banner">
		<nav class="fixednav">
...
<div id="main" role="main">
	<section id="contact" class="contactCK">
		<h1>contact</h1>
		<h2>確認</h2>
		<p>
			下記の内容で送信します。<br>
			編集する場合は[前画面に戻る]ボタンで前画面へ戻り、編集してください。
		</p>
<!-- ▼************ 送信内容表示部　※編集は自己責任で ************ ▼-->
<!-- <div id="formWrap"> -->
<?php if($empty_flag == 1){ ?>
...
<p id="pagetop"><a href="#top"><i class="fa fa-play"></i></a></p>
<div>
	<a href="#top"><img src="img/footer-logo.png" alt="jn" width="60" height="60"></a><br>
	Japan net-line Ltd., Inc<br>
	4-6 tamura-cho, atugi-shi, Kanagawa, zip.243-0016<br>
	Phone: 046.296.2245  Facsimile: 046.296.2246
</div>
<p>Copyright © Japan net-line Ltd., Inc. All Rights Reserved.</p>
</footer>
</body>
</html>
<?php
...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
	<meta name="format-detection" content="telephome=no">
	<link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,500,700,900|Noto+Sans:400,500,700,900" rel="stylesheet">
	<link rel="stylesheet" href="css/style.css">
	<link rel="stylesheet"href="css/font-awesome.min.css">
	<script src="https://code.jquery.com/jquery-1.11.2.min.js"></script>
	<script src="js/common.js"></script>
	<script src="js/site.js"></script>
	<title>お問い合わせ : 完了 - ジャパンネットライン</title>
</head>
<body>
	<header role="banner">
		<nav class="fixednav">
...
<?php }else{ ?>
	<div id="main" role="main">
		<section id="contact">
			...
			<p>
				メッセージを送信しました。<br>
				自動送信メールが送られますので、ご使用のメーラーで info@j-netline からのメールを受信できるように設定をお願いします。<br>
